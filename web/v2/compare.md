...
- **As of:** 2026-08-26
- **v1:** `/` · product stamp `v0.16.61`
- **v2:** `/v2/` · chip `v0.17.104-v2` · `/v2/VERSION` `0.17.104-v2` (skew closed 2026-08-27)
...
| 8 | Paste arbitrary PSBT `#cardPsbt` | **Ported** paste/inspect + Network dock if txid (`connect-src` still none) |
